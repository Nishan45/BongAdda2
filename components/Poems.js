...
import { SafeAreaView, View, StyleSheet, StatusBar, Dimensions, ActivityIndicator, Button, useWindowDimensions } from 'react-native'
...
function Poems({navigation,user,route}) {
    ...
    const loaddata = async () => {
        try {
            await axios.post(uri, { category: "Poem", skip: skip, time: time,email:email,limit:limit},{cancelToken:cancelToken.token}).then(res => {
