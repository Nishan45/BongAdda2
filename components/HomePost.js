...
const HomePost=({name,img,profimg,discription,postid,posttime,user_only,user_id,post,viewProf})=>{
  ...
  return (
    ...
    <View style={styles.container}>
     ...
     {!user_only&& email!=user_id && <ViewProfile uri={profimg} diameter={50} email={user_id} margin={10}/>}
    ...
    {discription &&<Text style={{fontSize:15,padding:10}}>{discription}</Text>}
